...
class TestOptionStrategies(TestCase):
    ...
    def test_generate_offsets(self):
        ...
        test_fixture_file = 'generate_offsets_' + test_quote_date_1 + '_fixture'
        path = os.path.join(os.sep, PROJECT_DIR, TEST_DIR, FIXTURES, test_fixture_file + ".csv")
        ...
        sc = OptionStrategies.generate_offsets(chains, test_width, shift_col)
